...
export function GalleryCta() {
  return (
    <section className="relative overflow-hidden py-20 lg:py-40 flex items-center justify-center min-h-[50vh]">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6 text-center text-white">
        ...
        <h2 className="mt-6 font-display text-4xl sm:text-5xl lg:text-7xl font-semibold leading-[1.1] tracking-tight">

...
export function SiteFooter() {
  return (
    <footer className="relative bg-[color:var(--ink)] overflow-hidden pt-10 pb-16 md:pb-12 border-t border-white/5">
      {/* Main Footer Content */}
      <div className="relative z-10 mx-auto grid max-w-7xl gap-10 lg:gap-16 px-6 sm:px-8 lg:grid-cols-[1.5fr_0.8fr_1fr] lg:px-12 pt-10 pb-16 lg:pb-48">
      ...
      <div className="absolute bottom-0 left-0 right-0 w-full overflow-hidden flex justify-center pointer-events-none select-none">
        <h1 className="font-display font-black text-[15vw] leading-none text-white opacity-15 lg:opacity-10 translate-y-1/4 whitespace-nowrap">
          SMILE HUB
        </h1>
      </div>
    </footer>
